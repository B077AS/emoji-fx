...
public class Emoji {
    ...
    static Emoji parseEmojiFromCSVList(List<String> v) {
        ...
        emoji.name = v.get(i++);
        emoji.unified = v.get(i++);
        emoji.nonQualified = getNullableField(v.get(i++));
        emoji.docomo = getNullableField(v.get(i++));
        emoji.au = getNullableField(v.get(i++));
        emoji.softbank = getNullableField(v.get(i++));
        emoji.google = getNullableField(v.get(i++));
        emoji.image = v.get(i++);
        emoji.sheetX = Integer.parseInt(v.get(i++));
        emoji.sheetY = Integer.parseInt(v.get(i++));
        ...
        emoji.category = v.get(i++);
        emoji.subcategory = v.get(i++);
        emoji.sortOrder = Integer.parseInt(v.get(i++));
        emoji.addedIn = v.get(i++);
        emoji.hasImgApple = Boolean.parseBoolean(v.get(i++));
        emoji.hasImgGoogle = Boolean.parseBoolean(v.get(i++));
        emoji.hasImgTwitter = Boolean.parseBoolean(v.get(i++));
        emoji.hasImgFacebook = Boolean.parseBoolean(v.get(i++));
