...
public class EmojiCsv {
    ...
    private List<EmojiCsv> skin_variations;
    ...
    public List<EmojiCsv> getSkin_variations() {
        return skin_variations;
    }

    public void setSkin_variations(List<EmojiCsv> skin_variations) {
    ...
    private <T> void appendFieldValue(StringBuilder dataBuilder, List<T> fieldValue) {
        if (fieldValue != null) {
            for (T t : fieldValue) {
                if (t instanceof EmojiCsv) {
                    dataBuilder.append(skinValueToString((EmojiCsv) t)).append(ITEMS_LIST_DELIMITER);
                } else {
    ...
    private String skinValueToString(EmojiCsv skinVariation) {
        StringBuilder dataBuilder = new StringBuilder();
